...
function Subscription() {
    ...
    const handlePaymentClick = async () => {
        ...
        if(userData.isPremium) {
            toast("You are already a premium member");
            return;
        }
        try {
            setLoading(true);
            ...
            const options = {
                ...
                currency: "INR",
                name: "Watchzy Corp",
                description: "Test WATCHZY Transaction",
        ...
        <div className="h-screen mt-[74px] w-full">
            ...
            <div className="mx-auto p-4 md:pt-8 pt-4">
                ...
                <div className="md:mx-16">
                    ...
                    <button
                        className="bg-yellow-400 p-3 md:mt-10 flex items-center justify-center font-medium rounded-lg mx-auto my-6"
